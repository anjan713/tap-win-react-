...
resetGame=()=>{
  ...
  return (
    ...
    <Text style={styles.topbartext}>Open up App.js to start working on your app!</Text>
    </View>
    <View style={styles.grid}>
      <View style={styles.itemrow}>
        ...
        onPress={()=>{
          this.scratchItem(0)}}>
          <FontAwesome name={this.scratchItemIcon(0)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(1)}}>
          <FontAwesome name={this.scratchItemIcon(1)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(2)}}>
          <FontAwesome name={this.scratchItemIcon(2)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(3)}}>
          <FontAwesome name={this.scratchItemIcon(3)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(4)}}>
          <FontAwesome name={this.scratchItemIcon(4)}
          size={50}
      ...
      <View style={styles.itemrow}>
        ...
        onPress={()=>{
          this.scratchItem(5)}}>
          <FontAwesome name={this.scratchItemIcon(5)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(6)}}>
          <FontAwesome name={this.scratchItemIcon(6)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(7)}}>
          <FontAwesome name={this.scratchItemIcon(7)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(8)}}>
          <FontAwesome name={this.scratchItemIcon(8)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(9)}}>
          <FontAwesome name={this.scratchItemIcon(9)}
          size={50}
      ...
      <View style={styles.itemrow}>
        ...
        onPress={()=>{
          this.scratchItem(10)}}>
          <FontAwesome name={this.scratchItemIcon(10)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(11)}}>
          <FontAwesome name={this.scratchItemIcon(11)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(12)}}>
          <FontAwesome name={this.scratchItemIcon(12)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(13)}}>
          <FontAwesome name={this.scratchItemIcon(13)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(14)}}>
          <FontAwesome name={this.scratchItemIcon(14)}
          size={50}
      ...
      <View style={styles.itemrow}>
        ...
        onPress={()=>{
          this.scratchItem(15)}}>
          <FontAwesome name={this.scratchItemIcon(15)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(16)}}>
          <FontAwesome name={this.scratchItemIcon(16)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(17)}}>
          <FontAwesome name={this.scratchItemIcon(17)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(18)}}>
          <FontAwesome name={this.scratchItemIcon(18)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(19)}}>
          <FontAwesome name={this.scratchItemIcon(19)}
          size={50}
      ...
      <View style={styles.itemrow}>
        ...
        onPress={()=>{
          this.scratchItem(20)}}>
          <FontAwesome name={this.scratchItemIcon(20)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(21)}}>
          <FontAwesome name={this.scratchItemIcon(21)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(22)}}>
          <FontAwesome name={this.scratchItemIcon(22)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(23)}}>
          <FontAwesome name={this.scratchItemIcon(23)}
          size={50}
        ...
        onPress={()=>{
          this.scratchItem(24)}}>
          <FontAwesome name={this.scratchItemIcon(24)}
          size={50}
         ...
         <Button full success style={styles.button} onPress={()=>{this.resetGame()}}>
